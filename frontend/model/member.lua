...
function Member.object:send_invitation(template_file, subject)
  ...
  if template_file then
    ...
    content = slot.use_temporary(function()
      ...
      slot.put("http://178.62.254.91" .. request.get_absolute_baseurl() .. "index/register.html?invite=" .. self.invite_code .. "\n\n")
      slot.put(_"If this link is not working, please open following url in your web browser:\n\n")
      slot.put("http://178.62.254.91" .. request.get_absolute_baseurl() .. "index/register.html\n\n")
...
function Member.object:set_notify_email(notify_email)
  ...
  local content = slot.use_temporary(function()
    ...
    slot.put("http://178.62.254.91" .. request.get_absolute_baseurl() .. "index/confirm_notify_email.html?secret=" .. self.notify_email_secret .. "\n\n")
    slot.put(_"If this link is not working, please open following url in your web browser:\n\n")
    slot.put("http://178.62.254.91" .. request.get_absolute_baseurl() .. "index/confirm_notify_email.html\n\n")
